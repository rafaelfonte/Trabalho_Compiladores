...
#
#- diretório "input" com todas as entradas para avaliação automática
#
#- binário do grupo compilado dentro de um subdiretório: g1
#
#Em seguida, lance:
#
#./testall.sh g1
...
do
	...
	EXPECTED_ERROR_CODE=`grep "$EXPECTED_ERROR " input/errors.h | awk '{ print $3 }'`
	...
	then
	    N=`grep " $GOT_ERROR_CODE " input/errors.h | awk '{ print $2 }'`
